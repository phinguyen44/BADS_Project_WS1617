...
lr.mod <- function(learner, traintask, testtask) {
  ...
  # make learner
  lr.model  <- makeLearner(learner, predict.type = "prob", predict.threshold = th)
...
dt.mod <- function(learner, traintask, testtask) {
  ...
  # make learner
  makeatree <- makeLearner(learner, predict.type = "prob", predict.threshold = th)
...
xgb.mod <- function(learner, traintask, testtask) {
  ...
  # make learner
  xg_set <- makeLearner(learner, predict.type = "prob", predict.threshold = th)
...
nn.mod <- function(learner, traintask, testtask){
  ...
  nn <- makeLearner(learner, predict.type = "prob", predict.threshold = th)
