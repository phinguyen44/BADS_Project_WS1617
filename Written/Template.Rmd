...
In this paper, an ensemble model will be developped in order to understand the features that drive product returns, predict them accuretely and increase profit.
