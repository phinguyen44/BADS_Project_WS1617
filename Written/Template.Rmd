...
nn.model = data.frame(nn.iteration, nn.size, nn.decay)
rf.model = data.frame(rf.iteration, rf.ntree, rf.mtry, rf.nodesize)

t1 = knitr::kable(nn.model, format = "latex", booktabs = TRUE)
t2 = knitr::kable(rf.model, format = "latex", booktabs = TRUE)
