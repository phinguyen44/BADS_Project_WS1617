...
Examples of such causes are uncertainty over a product, including, but not limited to incorrect fit, fraudulent behavior as well as damage inflicted by the customer or item defects [@potdar_2009]. 
